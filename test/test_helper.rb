...
require File.expand_path('../matchers/defined_matcher', __FILE__)
...
require File.expand_path('../matchers/ensure_matcher', __FILE__)
...
require File.expand_path('../matchers/lhs_matcher', __FILE__)
...
require File.expand_path('../matchers/op_assign_matcher', __FILE__)
...
require File.expand_path('../matchers/super_matcher', __FILE__)
...
require File.expand_path('../matchers/xstring_matcher', __FILE__)
